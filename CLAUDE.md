...
- **Still ahead, not started**: `ice-view.html`/`player-table.html`, and an actual `nhlratings.net` scraper run (script built and ready in `nhl/scripts/scrape_ratings.py`, blocked pending a real cooldown — see Ratings sources above).
